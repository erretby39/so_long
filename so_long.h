...
/*   Updated: 2025/04/09 16:14:59 by soer-ret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char	**map;
	int		c_valid; // to chek is all c are cepabel to collect
	int		x;
	int		y;
	int		e_path; // to chek the exit have a valide path
	int		c_collected; // coine collected
	int		c_count;
	int		p_count;
	int		e_count;
}	t_track;
...
void    map_parsing(char **av, char *buff, t_game *game, int ver_line); //vertical_line
